...
def main():
    ...
    func_transformer = FunctionTransformer(func=transformer, validate=True)
    ...
    svc_lab_model = make_pipeline(func_transformer, SVC(kernel='linear', C=1))
    ...
    # yes, you can leave this loop in if you want.
